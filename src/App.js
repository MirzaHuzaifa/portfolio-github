  ...
  return (
    <div className="App">
      <section
        ...
        style={{ backgroundImage: `linear-gradient(to right, #3D0F00,black)` }}
      >
            ...
            <div className="flex justify-betwen">
              ...
              <div className="shrink-0">
                <img
                  ...
                  alt="just-pic"
                  className="transition duration-150 ease-out cursor-pointer hover:scale-150 w-7"
                />
                <img
                  src="images/insta.png"
                  alt="just-pic"
                  className="mt-10 transition duration-150 ease-out cursor-pointer hover:scale-150 w-7"
                />
                <img
                  src="images/in.png"
                  alt="just-pic"
        ...
        <div className="custom-shape-divider-bottom-1669718815">
          <svg
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1200 120"
        ...
        <div
          id="myBtn"
          className="z-40 h-[634px] m-auto mx-auto fixed bg-[#430000] float-right hover:w-[100px] hover:ease-in-out"
          onClick={toggleWidth}
